              ...
              <?php
                ...
                <tr>
                  <td scope="row"><?php echo $a; ?></td>
                        ...
                        <td><?php echo $d; ?></td>
                        <td><?php echo $e; ?></td>
                        <td><img src="../images/<?php echo $f; ?>" width="100px"></td>
                        <td><img src="../images/<?php echo $g; ?>" width="100px"></td>
                        <td><a class="btn btn-primary" href="Edit-post.php?id=<?php echo $a; ?>&client=<?php echo $b; ?>&event=<?php echo $c; ?>&date=<?php echo $d; ?>&description=<?php echo $e; ?>&Cover=<?php echo $f; ?>&images=<?php echo $g; ?>">Edit</a></td>
