...
<div class="container my-5">
  ...
  <div id="testimonialCarousel" class="carousel slide testimonial-section" data-ride="carousel">
    ...
    <a class="carousel-control-prev" type="button" data-bs-target="#testimonialCarousel" data-bs-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden">Previous</span> </a> <a class="carousel-control-next" type="button" data-bs-target="#testimonialCarousel" data-bs-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden">Next</span> </a>
  </div>
</div>
<!-- testimonial end -->
 <!-- Experirnce start -->
  <div class="jumbotron">
    <h1 class="display-3" style="font-family: 'Cormorant Garamond', serif; font-size: 40px; line-height: 48px; text-align: center; letter-spacing: 0.05em; color: #000000;">Helping You Capture Your Best Moments</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form>
                ...
                <button type="submit" class="btn btn-outline-info" style="margin-top: 10px ;font-family: 'Cormorant Garamond'; font-style: normal; font-weight: 400; font-size: 28px; color: #505050;">Send</button>
            </form>
        </div>
        <div class="col-md-6">
  ...
  <div class="container-fluid" style="background: #E1EDF8; padding: 20px 0; margin-top: 20px;">
    <div class="row">
      ...
      <div class="col-md-4" style="text-align: center;">
        ...
        <p><i class="fa fa-camera"></i> Radiant Memories</p>
        <p><i class="fa fa-map-marker"></i> Raniban, Kathmandu</p>
        <p><i class="fa fa-envelope"></i> info.Radiantmemories@gmail.com</p>
        <p><i class="fa fa-phone"></i> +977 9812345678</p>
      </div>
      ...
      <div class="col-md-4" style="text-align: center;">
        <h4>Locate Us</h4>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14019.299145441686!2d77.10994291827024!3d28.544985752527197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1c3f7679573f%3A0xa6cf20e5f7741834!2sRadiant%20Photographer!5e0!3m2!1sen!2snp!4v1732616250907!5m2!1sen!2snp"  width="300" height="250" style="border: 0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
          </iframe>
